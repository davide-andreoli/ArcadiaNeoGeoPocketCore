//
//  NeoGeoPocketCore.swift
//  ArcadiaNeoGeoPocketCore
//
//  Created by Davide Andreoli on 26/07/24.
//

import Foundation
import ArcadiaCore

@Observable public class ArcadiaNeoGeoPocket: ArcadiaCoreProtocol {
    
    public typealias ArcadiaCoreType = ArcadiaNeoGeoPocket
